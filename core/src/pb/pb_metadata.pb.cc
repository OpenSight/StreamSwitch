...
void protobuf_AssignDesc_pb_5fmetadata_2eproto() {
  ...
  static const int ProtoSubStreamInfo_offsets_[15] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ProtoSubStreamInfo, sub_stream_index_),
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ProtoSubStreamInfo, size_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ProtoSubStreamInfo, font_),
  };
...
void protobuf_AddDesc_pb_5fmetadata_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\021pb_metadata.proto\022\rstream_switch\"\312\002\n\022P"
    "rotoSubStreamInfo\022\030\n\020sub_stream_index\030\001 "
    "\001(\005\022:\n\nmedia_type\030\002 \001(\0162&.stream_switch."
    "ProtoSubStreamMediaType\022\030\n\ncodec_name\030\003 "
    "\001(\t:\004h264\022\022\n\nextra_data\030\004 \001(\014\022\016\n\006height\030"
    "\024 \001(\r\022\r\n\005width\030\025 \001(\r\022\013\n\003fps\030\026 \001(\r\022\013\n\003gov"
    "\030\027 \001(\r\022\032\n\022samples_per_second\030\036 \001(\r\022\020\n\010ch"
    "annels\030\037 \001(\r\022\027\n\017bits_per_sample\030  \001(\r\022\t\n"
    "\001x\030( \001(\r\022\t\n\001y\030) \001(\r\022\014\n\004size\030* \001(\r\022\014\n\004fon"
    "t\030+ \001(\t\"\016\n\014ProtoMetaReq\"\250\001\n\014ProtoMetaRep"
    "\022/\n\tplay_type\030\001 \001(\0162\034.stream_switch.Prot"
    "oPlayType\022\024\n\014source_proto\030\002 \001(\t\022\014\n\004ssrc\030"
    "\003 \001(\r\022\013\n\003bps\030\004 \001(\r\0226\n\013sub_streams\030@ \003(\0132"
    "!.stream_switch.ProtoSubStreamInfo*E\n\rPr"
    "otoPlayType\022\030\n\024PROTO_PLAY_TYPE_LIVE\020\000\022\032\n"
    "\026PROTO_PLAY_TYPE_REPLAY\020\001*\266\001\n\027ProtoSubSt"
    "reamMediaType\022%\n!PROTO_SUB_STREAM_MEIDA_"
    "TYPE_VIDEO\020\000\022%\n!PROTO_SUB_STREAM_MEIDA_T"
    "YPE_AUDIO\020\001\022$\n PROTO_SUB_STREAM_MEIDA_TY"
    "PE_TEXT\020\002\022\'\n#PROTO_SUB_STREAM_MEIDA_TYPE"
    "_PRIVATE\020\003", 810);
...
#ifndef _MSC_VER
const int ProtoSubStreamInfo::kSubStreamIndexFieldNumber;
...
const int ProtoSubStreamInfo::kSizeFieldNumber;
const int ProtoSubStreamInfo::kFontFieldNumber;
#endif  // !_MSC_VER
...
#define ZR_(first, last) do {                              \
  ...
  if (_has_bits_[0 / 32] & 255) {
    ZR_(sub_stream_index_, media_type_);
    ZR_(height_, gov_);
    if (has_codec_name()) {
      if (codec_name_ != _default_codec_name_) {
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 41: {
        ...
        if (input->ExpectTag(336)) goto parse_size;
        break;
      }
      ...
      case 42: {
        ...
        if (input->ExpectTag(346)) goto parse_font;
        break;
      }
...
void ProtoSubStreamInfo::SerializeWithCachedSizes(
  ...
  // optional uint32 size = 42;
  if (has_size()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(42, this->size(), output);
  }
...
::google::protobuf::uint8* ProtoSubStreamInfo::SerializeWithCachedSizesToArray(
  ...
  // optional uint32 size = 42;
  if (has_size()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(42, this->size(), target);
  }
